...
/// <summary>
/// Input helper. Translates mouse inputs to a touch using TouchCreator.cs
/// </summary>
public class InputHelper : MonoBehaviour
{
    ...
    public static List<Touch> GetTouches()
    {
		...
		/// IF UNITY_EDITOR checks whether you are in the Unity Editor or not, this is a tool to have the mouse 'pretending' to be a touch device.
#if UNITY_EDITOR
